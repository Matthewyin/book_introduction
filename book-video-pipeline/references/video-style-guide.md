...
1. **定妆图**：全局定妆图已就位（6 张人设：`anime-girl / anime-boy / realistic-literary-female / realistic-intellectual-female / realistic-literary-male / realistic-intellectual-male`），所有集共用；
   仅当某集需要不同角色时才单独生成本集定妆图。选定的人设定妆图定义主角的角色身份。
