...
| **viral** | 干货/方法论/冲击力 | 站酷酷黑超大字号（~180px）+ 字间距5% + 白字投影 | 亮黄圆角标签底 + 黑字（左对齐） | 同 palette |
...
```
┌────────────────────────────────────┐
│ 顶部品牌区 (~4%)     左上：logo  右上：好书推荐/EP   │
│ 书名区 (~18–38%)     居中：书名（≤6字/行，超6字折行，│
│                      viral 站酷酷黑~180px+字间距） │
│ 钩子+作者 (~38–48%)  左对齐：钩子（viral 亮黄标签）  │
│                      作者（小字，左对齐）          │
│ 人物+书封 (48–100%)   Q版小美女右下 + 书在左侧      │
│                      （一体式留白，与顶部无缝衔接）  │
└────────────────────────────────────┘
```
