...
Style: gentle cel-shaded anime with soft watercolor edges, warm diffused sunlight, subtle paper-like texture, clean linework with occasional loose strokes. Big expressive eyes, soft blush, warm smile or tender pensive expression. The mood is intimate, youthful, and quietly emotional — like a scene from a slice-of-life anime or a shoujo manga panel.
...
Negative: no realistic photography, no 3D render, no thick oil painting, no flat vector art, no chibi / super-deformed proportions, no realistic anatomy, no neon, no harsh clashing colors, no readable text, no watermark, no UI elements, no complex patterns on clothing.
