...
所有含人物的镜头，主角必须出现，标 `characters: true`。主角是叙事视角——口播全程是
她的声音，画面里她也必须在场。绝不能出现匿名陌生人独自承担情绪戏。

- **重演场景**（口播讲别人的故事）→ 主角当**见证者**，在画面一角目睹
- **讲解场景**（口播讲书/方法/观点）→ 主角当**主讲人**，面对观众讲解

`characters: false` 仅用于纯环境/无人物镜头（书封特写、空镜、抽象背景）。

### 2. 抽象概念不靠生图

方法论、概念对比、数字列举等抽象内容，生图只画"主角讲解/反应的姿态"，概念本身不画。
